...
public class DataBaseHandler {
    ...
    public void changeAccount(int id,
        ...
        String update = "UPDATE "+Constant.TABLE_NAME+" SET "+Constant.NAME+" = ?, "+Constant.SURNAME+" = ?, "+Constant.SEX+" = ?, "+Constant.BIRTHDATE+" = ?, "
                +Constant.BIRTHPLACE+" = ?, "+Constant.DOCNUMBER+" = ?, "+Constant.DOCTYPE+" = ?, "+Constant.IDNumber+" = ?, "+Constant.PHOTO+" = ?, "
                + Constant.DocFirstPage+" = ?, "+Constant.DocumentSecondPage+" = ? WHERE id = "+id;
    ...
    public Account findAccountById(int id) throws SQLException {
        ...
        String find = "SELECT * FROM "+Constant.TABLE_NAME+" WHERE id="+id;
